...
class TestRiverGet(BaseTest):
    """Test for River"""

    @pytest.mark.django_db
    def test_river_details(self, client, sample_river):
        """River Details"""
        expected_name, expected_length, expected_id = sample_river
        river_details_response = client.get(reverse('river-details', kwargs={'pk': expected_id}))
